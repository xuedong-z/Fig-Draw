...
const STRINGS = {
  ...
  "axis.sizesHint": { en: "Figure-wide · click Apply to push to all panels", zh: "全局尺寸 · 点「应用」推到所有面板" },
  ...
  "legend.move": { en: "Move", zh: "位置" },
  "legend.moveAll": { en: "Move legend", zh: "整体移动" },
  "legend.spacing": { en: "Entry spacing", zh: "项间距" },
  "legend.tighter": { en: "Tighter", zh: "更紧" },
  "legend.looser": { en: "Looser", zh: "更松" },
  "title.heading": { en: "Title", zh: "标题" },
  "title.none": { en: "No chart title detected", zh: "未识别到图表标题" },
  "title.designate": { en: "Mark a text as the title…", zh: "把某段文字设为标题…" },
  "title.move": { en: "Move title", zh: "移动标题" },
  "title.fontHint": { en: "Title font size is set in", zh: "标题字号统一调整见" },
  ...
  "type.desc": { en: "Targets by role; grey numbers are Nature recommendations. After laying panels out, click Apply to normalize every sub-figure to these sizes.", zh: "按角色设定目标值；灰色数字为 Nature 推荐值。排好面板后，点击「应用」将每个子图归一到这些尺寸。" },
  ...
  "tune.editImg": { en: "Edit image", zh: "编辑图片" },
  "tune.imgCrop": { en: "Crop (zoom)", zh: "裁剪（放大）" },
  "tune.imgPos": { en: "Position", zh: "位置" },
  "tune.imgReset": { en: "Reset image", zh: "重置图片" },
  "tune.imgHint": { en: "Zoom in to crop the edges; arrows pan the image inside the panel.", zh: "放大可裁掉边缘；方向键在面板内平移图片。" },
